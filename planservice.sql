...
CREATE TABLE `plan` (
  ...
  `porductDateType` varchar(100) NOT NULL COMMENT '属性值来自数据字典',
...
-- Records of style
-- ----------------------------
INSERT INTO `style` VALUES ('1', '10190114(CX1901)', '1', '1', 'KSZ20190101001', '款式1组', '1', '2', '3', '张三', '信息管理', '2018-08-20 12:00:00', '\0');
