...
public interface AuthorityModifyMapper {
    @Insert("INSERT INTO user_customer_brand(userId, userName, customerId, brandId) VALUES(#{authorityReq.userId}, " +
            "#{authorityReq.userName}, #{authorityReq.customerId}, #{authorityReq.brandId});")
